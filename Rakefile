...
MANUSCRIPT_DIR = PUBLICATION_DIR / 'manuscript'
MANUSCRIPT_FILES = FileList[MANUSCRIPT_DIR / '**/*']
...
EPUB_PUBLICATION_FILES = FileList[PUBLICATION_DIR / 'epub/**/*']
EPUB_FILE = (OUT_DIR / SLUG).ext('epub')

file EPUB_FILE => EPUB_TEMPLATE_FILES
file EPUB_FILE => EPUB_PUBLICATION_FILES
file EPUB_FILE => MANUSCRIPT_FILES
file EPUB_FILE => PUBLICATION_DATA_FILE
file EPUB_FILE => EPUB_TEMPLATE_FILES + MANUSCRIPT_FILES + EPUB_PUBLICATION_FILES + [PUBLICATION_DATA_FILE] do |t|
  cd(EPUB_BUILD_DIR) { sh 'rake', "DBP_PUBLICATION_DIR=#{PUBLICATION_DIR}", "DBP_EPUB_FILE=#{t.name}" }
end
...
PDF_PUBLICATION_FILES = FileList[PUBLICATION_DIR / 'pdf/**/*']
PDF_FILE = EPUB_FILE.ext('pdf')

file PDF_FILE => PDF_TEMPLATE_FILES
file PDF_FILE => PDF_PUBLICATION_FILES
file PDF_FILE => MANUSCRIPT_FILES
file PDF_FILE => PUBLICATION_DATA_FILE
file PDF_FILE => PDF_FORMAT_FILE do |t|
